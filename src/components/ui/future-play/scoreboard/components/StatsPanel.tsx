...
const StatsPanel: React.FC<StatsPanelProps> = ({
  ...
  return (
    <div className="bg-navy-dark rounded-lg overflow-hidden border border-navy/20 shadow-lg">
      ...
      <div className="p-4">
        {/* Players and Score - Even more compact */}
        <div className="flex items-center justify-between mb-2.5">
          <div className="flex items-center gap-1">
            <div className="w-7 h-7 rounded-full overflow-hidden border-2 border-primary ring-2 ring-primary/30">
              <img 
            ...
            <div>
              <div className="text-white text-xs font-semibold">{player1Stats.name}</div>
              <div className="text-primary text-[10px]">{player1Stats.winRate} win rate</div>
            </div>
          </div>
          
          <div className="flex items-center gap-1">
            <span className="text-primary text-2xl font-bold">{player1Score}</span>
            <span className="text-white/50 text-xl">-</span>
            <span className="text-[#0EA5E9] text-2xl font-bold">{player2Score}</span>
          </div>
          
          <div className="flex items-center gap-1">
            <div>
              <div className="text-white text-xs font-semibold text-right">{player2Stats.name}</div>
              <div className="text-[#0EA5E9] text-[10px] text-right">{player2Stats.winRate} win rate</div>
            </div>
            <div className="w-7 h-7 rounded-full overflow-hidden border-2 border-[#0EA5E9] ring-2 ring-[#0EA5E9]/30">
              <img 
        ...
        {/* Current Set - Even smaller */}
        <div className="flex justify-center mb-2 text-white/70">
          <div className="px-2 py-0.5 rounded-full bg-navy/40 border border-white/10 text-[10px]">
        ...
        {/* Stats Comparisons - More compact with closer values to center */}
        <div className="space-y-2">
          {/* Top Speed */}
          <div className="grid grid-cols-7 items-center">
            <div className="col-span-2 text-primary text-sm font-semibold text-right pr-3">47 mph</div>
            <div className="col-span-3 flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
                <Zap className="w-3.5 h-3.5 text-[#F97316]" />
                <span className="text-white/80 text-xs uppercase">Top Speed</span>
              </div>
              <div className="px-2 py-0.5 rounded-full bg-navy-light/40 text-white/50 text-[10px]">vs</div>
            </div>
            <div className="col-span-2 text-[#0EA5E9] text-sm font-semibold text-left pl-3">52 mph</div>
          </div>
          
          {/* Accuracy */}
          <div className="grid grid-cols-7 items-center">
            <div className="col-span-2 text-primary text-sm font-semibold text-right pr-3">92%</div>
            <div className="col-span-3 flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
                <div className="w-3.5 h-3.5 flex items-center justify-center rounded-full border border-[#D946EF] text-[#D946EF]">●</div>
                <span className="text-white/80 text-xs uppercase">Accuracy</span>
              </div>
              <div className="px-2 py-0.5 rounded-full bg-navy-light/40 text-white/50 text-[10px]">vs</div>
            </div>
            <div className="col-span-2 text-[#0EA5E9] text-sm font-semibold text-left pl-3">88%</div>
          </div>
          
          {/* Spin Rate */}
          <div className="grid grid-cols-7 items-center">
            <div className="col-span-2 text-primary text-sm font-semibold text-right pr-3">1800 rpm</div>
            <div className="col-span-3 flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
            ...
            <div className="col-span-2 text-[#0EA5E9] text-sm font-semibold text-left pl-3">2100 rpm</div>
          </div>
          
          {/* Reaction Time */}
          <div className="grid grid-cols-7 items-center">
            <div className="col-span-2 text-primary text-sm font-semibold text-right pr-3">0.4s</div>
            <div className="col-span-3 flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
            ...
            <div className="col-span-2 text-[#0EA5E9] text-sm font-semibold text-left pl-3">0.5s</div>
          </div>
        </div>
        ...
        <div className="mt-3">
          <div className="flex items-center justify-between mb-1">
            <h4 className="text-white/90 text-xs font-medium">Win Probability</h4>
            <div className="flex items-center gap-1">
          ...
          <div className="flex items-center text-[10px] text-white/70 mb-0.5">
        ...
        <div className="mt-3 pt-2 border-t border-white/10 flex items-center gap-2 text-xs">
          <div className="flex-1 flex items-center bg-navy-light/30 rounded-full px-2 py-1">
            <Zap className="w-3 h-3 mr-1 text-[#F97316]" />
            <span className="text-white/80 text-[10px]">Current ball speed: <span className="text-white font-medium">{Math.round(ballVelocity)} mph</span></span>
          </div>
        </div>
      </div>
    </div>
