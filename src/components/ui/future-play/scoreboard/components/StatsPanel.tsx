...
const StatsPanel: React.FC<StatsPanelProps> = ({
  ...
  return (
    <div className="bg-navy-dark rounded-lg overflow-hidden border border-navy/20 shadow-lg">
      ...
      <div className="p-4">
        {/* Players and Score - Slightly more compact */}
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1.5">
            <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-primary ring-2 ring-primary/30">
              <img 
          ...
          <div className="flex items-center gap-1">
            <span className="text-primary text-3xl font-bold">{player1Score}</span>
            <span className="text-white/50 text-xl">-</span>
            <span className="text-[#0EA5E9] text-3xl font-bold">{player2Score}</span>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-[#0EA5E9] ring-2 ring-[#0EA5E9]/30">
              <img 
        ...
        {/* Current Set - Made smaller */}
        <div className="flex justify-center mb-3 text-white/70">
          <div className="px-2 py-0.5 rounded-full bg-navy/40 border border-white/10 text-xs">
        ...
        {/* Stats Comparisons - More compact layout */}
        <div className="space-y-3">
          {/* Top Speed */}
          <div className="grid grid-cols-3 items-center">
            <div className="text-primary text-sm font-semibold">47 mph</div>
            ...
            <div className="text-[#0EA5E9] text-sm font-semibold text-right">52 mph</div>
          </div>
          
          {/* Accuracy */}
          <div className="grid grid-cols-3 items-center">
            <div className="text-primary text-sm font-semibold">92%</div>
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
            ...
            <div className="text-[#0EA5E9] text-sm font-semibold text-right">88%</div>
          </div>
          
          {/* Spin Rate */}
          <div className="grid grid-cols-3 items-center">
            <div className="text-primary text-sm font-semibold">1800 rpm</div>
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
            ...
            <div className="text-[#0EA5E9] text-sm font-semibold text-right">2100 rpm</div>
          </div>
          
          {/* Reaction Time */}
          <div className="grid grid-cols-3 items-center">
            <div className="text-primary text-sm font-semibold">0.4s</div>
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-1 mb-0.5">
            ...
            <div className="text-[#0EA5E9] text-sm font-semibold text-right">0.5s</div>
          </div>
        </div>
        ...
        <div className="mt-4 pt-2 border-t border-white/10 flex items-center gap-2 text-xs">
