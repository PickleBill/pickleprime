...
const PlayerModalHeader = ({ onClose }: PlayerModalHeaderProps) => {
  return (
    <div className="sticky top-0 bg-[#8B5CF6] p-4 border-b border-white/10 flex items-center justify-between z-10">
      <h3 className="text-xl font-bold text-white">PickleBills Player Dashboard</h3>
      <button 
        onClick={onClose}
        className="p-2 rounded-full hover:bg-[#9b87f5]/80 transition-colors"
        aria-label="Close"
      >
